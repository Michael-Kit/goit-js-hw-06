...
// cтать яких(властивість gender) збігається зі значенням параметра gender.
...
// const getTotalBalanceByGender = (users, gender) => users.filter(user => user.gender === gender) // Фільтруємо користувачів за статтю
//       .reduce((total, user) => total + user.balance, 0); // Підсумовуємо balance
const clients = [
	{
    name: "Moore Hensley",
    gender: "male",
